...
// Allow camera position to be passed as a prop
// Set a closer (more zoomed-in) default camera position
const DEFAULT_CAM_FROM = [-18, -3, 5];

function NozzleScene() {
  return (
    <>
...
function NozzleSimulationSmall({ cameraPosition }) {
  const containerRef = useRef(null);
  // No need for inView or animation anymore
  const camFrom = cameraPosition || DEFAULT_CAM_FROM;

  return (
    <div className="w-full" ref={containerRef}>
      <div className="w-full h-[180px] md:h-[220px] lg:h-[260px] overflow-hidden rounded-sm cursor-grab active:cursor-grabbing">
        <Canvas
          camera={{ position: camFrom, fov: 45 }}
...
export default NozzleSimulationSmall;